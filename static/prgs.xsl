		...
		<html>
			...
			<body onload="DeveloperMenu.initialize();">
				<header id="header" class="main-layout">
					<img src="devmenu/logo.gif" alt="GeneXus" />
				</header>
					...
					<div id="kbn-box" class="box box-disabled">
						...
						<div>
							...
							<div class="download-box">
								<header>
									<h1>Get Knowledge Base Navigator for your device:</h1>
								</header>
								<a href="http://itunes.apple.com/us/app/knowledge-base-navigator/id404011922" target="_blank">iOS</a>
								<a href="https://market.android.com/details?id=com.artech.prototyper" target="_blank">Android</a>
								<a href="https://appworld.blackberry.com/webstore/content/21098/" target="_blank">BlackBerry</a>
							</div>
